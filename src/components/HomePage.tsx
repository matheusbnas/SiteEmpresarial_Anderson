    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-start">
        ...
        <div className="relative z-10 w-full px-6 lg:px-12">
          <div className="max-w-3xl">
            <div className="mb-8">
              <p className="text-lg text-gray-300 italic mb-4">Transformação estratégica com essência</p>
            </div>
      ...
      <section className="relative min-h-screen flex items-center justify-start">
        ...
        <div className="relative z-10 w-full px-6 lg:px-12">
          <div className="max-w-3xl">
            <div className="mb-6">
              <p className="text-lg text-gray-300 italic">Transformação estratégica com essência</p>
            </div>
            
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 leading-tight">
              O QUE VOCÊ VÊ AQUI NÃO É UM CURRÍCULO.<br />
              <span className="text-yellow-400">É A ARQUITETURA DE QUEM DECIDIU SER O QUE ENTREGA.</span>
            </h1>
            
            <div className="mb-12">
              <p className="text-lg md:text-xl text-gray-200 leading-relaxed mb-8">
                Esse é meu Branding Book. Não feito para agradar. Feito para alinhar.<br />
                Aqui você vai entender quem sou, por que faço o que faço — e com quem faço questão de caminhar.
              </p>
            </div>
